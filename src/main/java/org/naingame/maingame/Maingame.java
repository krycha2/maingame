...
import org.naingame.maingame.system.JoinListener;
...
public final class Maingame extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new JoinListener(dataPlayerMenager), this);

        // Rejestracja komendy z osobnym Executorem
        this.getCommand("minegame").setExecutor(new MainGcommand());

        getLogger().info("Plugin wystartował.");
    }
