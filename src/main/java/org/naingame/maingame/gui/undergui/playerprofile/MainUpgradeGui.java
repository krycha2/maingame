    ...
    public MainUpgradeGui(){
        ...
        this.addButton(new Button(10) {
            ...
            public ItemStack getItem() {
                ...
                if (meta != null){
                    meta.setDisplayName(plugin.getLangManager().get("messages.messages.gui.mianupgradegui.fish_upgrade"));
                    List<String> lore = Arrays.asList(plugin.getLangManager().get("messages.gui.mianupgradegui.fish_upgrade_lore").split("\n"));
